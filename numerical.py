...
vector1 = vector(vector_columnID='ID',vectorID=5).csvVector('test2.csv')
vector2 = vector(vector_columnID='ID',vectorID=3).csvVector('test2.csv')
vector3 = vector(vector_columnID='ID',vectorID=4).csvVector('test2.csv')
ref_vector = vector(vector_columnID='ID',vectorID=1).csvVector('test2.csv')
variances = dimension(vector1, vector2).vectorVariance(ref_vector,realtiveID=False)
new_vectors = featureData(1,2).updateTraits(2,vector1,vector2,vector3)
